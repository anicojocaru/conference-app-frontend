...
function ConferenceFilters(props)  {
    ...
    const handleKeyPressed = useCallback((event) => event.keyCode===13 && handleApplyButton(), [handleApplyButton])
    ...
    <>
        ...
        <Button size={"sm"} color={"primary"} right={true} on click={handleApplyButton}>
